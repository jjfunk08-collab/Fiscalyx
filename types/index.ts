...
export interface Instrument {
  symbol: string; // internal terminal symbol (e.g. "GOLD", "SPX", "BTC")
  name: string;
  assetClass: AssetClass;
  currency: string;
  sector?: string;
  yahoo?: string; // Yahoo Finance ticker (e.g. "GC=F", "^GSPC", "AAPL")
  twelvedata?: string; // Twelve Data symbol (e.g. "AAPL", "EUR/USD", "XAU/USD")
  etf?: string; // ETF proxy ticker for indices/futures (e.g. SPX→SPY, OIL→USO)
  coingeckoId?: string; // CoinGecko id for crypto (e.g. "bitcoin")
}
...
export interface Quote {
  ...
  peRatio?: number | null; // trailing P/E where available
  tick: TickDirection;
