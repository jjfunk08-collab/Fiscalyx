...
export default function MarketGrid({ compact = false }: { compact?: boolean }) {
  const { quotes, ticks, updatedAt, error, loaded } = useLive();
  ...
  return (
    <div className="panel h-full">
      ...
      <div className="panel-body">
        {error && quotes.length > 0 && (
          <div className="px-2 py-1 text-[10px] text-term-red border-b border-term-border bg-term-red/5">
              ...
              <tr>
                <td
                  ...
                  className={cn(
                    ...
                    error && quotes.length === 0 ? "text-term-red" : "text-term-dim"
                  )}
                >
                  {emptyMessage}
                </td>
